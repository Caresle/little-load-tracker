	...
	return (
		<div
			className={cn(
				...
				{
					"bg-emerald-200/50 text-emerald-500 border border-emerald-500":
						load.loadStatus === LOAD_STATUS.COMPLETED,

					"bg-red-200/50 text-red-500 border border-red-500":
						load.loadStatus === LOAD_STATUS.FAILED,
					"bg-amber-200/50 text-amber-500 border border-amber-500":
						load.loadStatus === LOAD_STATUS.IN_PROGRESS,
					"bg-slate-200/50 text-slate-500 border border-slate-500":
